...
Notes: 
 ...
 Примечания:
  ...
  - Просмотрите [документы] (https://reactjs.org/docs/hooks-reference.html#useeffect)
...
## Эффект с очисткой
Довольно часто эффект очищается через некоторое время. Это возможно путем возврата функции из функции эффекта, переданной в `useEffect`.
